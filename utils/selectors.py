    ...
    def __init__(self):
        ...
        self.site_selectors = {
            'timesofindia.indiatimes.com': [
                '.Normal', '._3YYSt', '.article-content h1, .article-content h2, .article-content h3, .article-content p'
            ],
            'hindustantimes.com': [
            ...
            'indianexpress.com': [
                '.story-element-text', '.ie-customstory h1, .ie-customstory h2, .ie-customstory h3, .ie-customstory p'
            ],
            'ndtv.com': [
                '.sp-cn', '.ins__story-body h1, .ins__story-body h2, .ins__story-body h3, .ins__story-body p'
            ],
            'news18.com': [
            ...
            'cnn.com': [
                '.zn-body__paragraph', '.el__leafmedia--sourced-paragraph',
        ...
        self.exclude_terms = [
            'trending', 'headlines', 'videos', 'gallery', 'opinion', 'cookies',
            'privacy', 'terms', 'conditions', 'subscribe', 'newsletter',
            'advertisement', 'recommended', 'related', 'popular', 'more news',
