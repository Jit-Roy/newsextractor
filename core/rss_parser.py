...
class RSSParser:
    ...
    def is_rss_feed(self, url: str) -> bool:
        ...
        try:
            ...
            rss_patterns = [
                r'\.xml$', r'\.rss$', r'/rss/', r'/feed/', r'/feeds/',
                r'rss\.xml$', r'feed\.xml$', r'atom\.xml$', r'/rss$', r'/feed$'
            ]
    ...
    def parse_feed(self, feed_url: str, limit: Optional[int] = None) -> List[Dict]:
        ...
        try:
            ...
            self.logger.info(f"Successfully parsed {len(articles_data)} entries from RSS feed")
