...
class NLPProcessor:
    ...
    def __init__(
        ...
        if SPACY_AVAILABLE:
            try:
                ...
                self.logger.warning(
                    f"spaCy model {spacy_model} not found. NER and advanced features disabled."
                )
    ...
    def _summarize_with_transformers(self, text: str) -> str:
        ...
        try:
            ...
            summary = self.summarizer(
                truncated_text, max_length=150, min_length=50, do_sample=False
            )
    ...
    def _summarize_simple(self, text: str) -> str:
        ...
        for sentence in sentences:
            ...
            if len(sentence) > 30 and not sentence.lower().startswith(
                ("click", "read more", "subscribe")
            ):
